...
if __name__ == '__main__':
    ...
    #     rating_by_score=True, filter_by_city="")
    ...
    train_ds, test_ds, ds, all_output_features = torch.load("checkpoints_v10_sfr_mistral_top_2000_fix_input_2layerModel_raw_feature_prediction_baseline/all_dataset.pt")
    # root_dir = "/net/scratch/llm_negotiation/highlight_extraction/highlight_model_Meta-Llama-3.1-70B-Instruct_extracted_features_all_data_predict_raw_feature_baseline_top_2000"
    ...
    state_dict = torch.load("checkpoints_v10_sfr_mistral_top_2000_fix_input_2layerModel_raw_feature_prediction_baseline/feature_classifier_best_mlp_mean.pt", weights_only=True)
    ...
    with open(infer_data_filename.replace(".json", "_output_fixed_raw_feature_prediction_baseline.json"), "w", encoding='utf-8') as f_out:
